...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BranchContentBlock.title'
        db.delete_column(u'tradeschool_branchcontentblock', 'title')

        # Adding field 'BranchContentBlock.content_type'
        db.add_column(u'tradeschool_branchcontentblock', 'content_type',
                      self.gf('django.db.models.fields.CharField')(default='main_intro', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BranchContentBlock.title'
        db.add_column(u'tradeschool_branchcontentblock', 'title',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100),
                      keep_default=False)

        # Deleting field 'BranchContentBlock.content_type'
        db.delete_column(u'tradeschool_branchcontentblock', 'content_type')
    ...
    models = {
        ...
        u'tradeschool.branchcontentblock': {
            'Meta': {'object_name': 'BranchContentBlock'},
        ...
        u'tradeschool.person': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'b3e0a700c81711e2a0cc14109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'tradeschool.schedule': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'b3e284bac81711e2a13814109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#a82711'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
