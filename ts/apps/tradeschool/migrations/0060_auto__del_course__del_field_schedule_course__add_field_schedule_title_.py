...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Schedule.course'
        db.delete_column(u'tradeschool_schedule', 'course_id')

        # Adding field 'Schedule.title'
        db.add_column(u'tradeschool_schedule', 'title',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=255),
                      keep_default=False)

        # Adding field 'Schedule.teacher'
        db.add_column(u'tradeschool_schedule', 'teacher',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='courses_taught', to=orm['tradeschool.Person']),
                      keep_default=False)

        # Adding field 'Schedule.description'
        db.add_column(u'tradeschool_schedule', 'description',
                      self.gf('django.db.models.fields.TextField')(default='aaa'),
                      keep_default=False)

        # Adding field 'Schedule.max_students'
        db.add_column(u'tradeschool_schedule', 'max_students',
                      self.gf('django.db.models.fields.IntegerField')(default=20, max_length=4),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Schedule.course'
        db.add_column(u'tradeschool_schedule', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.Course']),
                      keep_default=False)

        # Deleting field 'Schedule.title'
        db.delete_column(u'tradeschool_schedule', 'title')

        # Deleting field 'Schedule.teacher'
        db.delete_column(u'tradeschool_schedule', 'teacher_id')

        # Deleting field 'Schedule.description'
        db.delete_column(u'tradeschool_schedule', 'description')

        # Deleting field 'Schedule.max_students'
        db.delete_column(u'tradeschool_schedule', 'max_students')
    ...
    models = {
        ...
        u'tradeschool.registration': {
            'Meta': {'ordering': "['-schedule__start_time', 'schedule', 'registration_status', 'student']", 'unique_together': "(('schedule', 'student'),)", 'object_name': 'Registration'},
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'tradeschool.schedule': {
            'Meta': {'ordering': "['schedule_status', 'start_time', '-venue', 'title']", 'object_name': 'Schedule'},
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tradeschool.Branch']"}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#a534dc'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
