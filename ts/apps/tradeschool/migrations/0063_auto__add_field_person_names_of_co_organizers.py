...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.names_of_co_organizers'
        db.add_column(u'tradeschool_person', 'names_of_co_organizers',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.names_of_co_organizers'
        db.delete_column(u'tradeschool_person', 'names_of_co_organizers')
    ...
    models = {
        ...
        u'tradeschool.course': {
            ...
            'color': ('django.db.models.fields.CharField', [], {'default': '4', 'max_length': '7'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
        ...
        u'tradeschool.person': {
            ...
            'names_of_co_organizers': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#7eba91'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
