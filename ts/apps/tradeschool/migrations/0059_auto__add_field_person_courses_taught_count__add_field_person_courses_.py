...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.courses_taught_count'
        db.add_column(u'tradeschool_person', 'courses_taught_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=7),
                      keep_default=False)

        # Adding field 'Person.courses_taken_count'
        db.add_column(u'tradeschool_person', 'courses_taken_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.courses_taught_count'
        db.delete_column(u'tradeschool_person', 'courses_taught_count')

        # Deleting field 'Person.courses_taken_count'
        db.delete_column(u'tradeschool_person', 'courses_taken_count')
    ...
    models = {
        ...
        u'tradeschool.schedule': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 22, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 22, 0, 0)'}),
        ...
        u'tradeschool.timerange': {
            ...
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tradeschool.Branch']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 22, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 22, 0, 0)'}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#154e17'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
