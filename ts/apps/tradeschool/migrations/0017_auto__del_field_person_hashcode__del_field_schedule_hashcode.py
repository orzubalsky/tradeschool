...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Person.hashcode'
        db.delete_column(u'tradeschool_person', 'hashcode')

        # Deleting field 'Schedule.hashcode'
        db.delete_column(u'tradeschool_schedule', 'hashcode')


    def backwards(self, orm):
        # Adding field 'Person.hashcode'
        db.add_column(u'tradeschool_person', 'hashcode',
                      self.gf('django.db.models.fields.CharField')(default='abdb8526d21b11e2b4c714109fdfc929', max_length=32, unique=True),
                      keep_default=False)

        # Adding field 'Schedule.hashcode'
        db.add_column(u'tradeschool_schedule', 'hashcode',
                      self.gf('django.db.models.fields.CharField')(default='abdd76a6d21b11e2a41814109fdfc929', max_length=32, unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'tradeschool.schedule': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 0, 0)'}),
        ...
        u'tradeschool.timerange': {
            ...
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tradeschool.Branch']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 11, 0, 0)'}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#f06e89'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
