...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'BranchContentBlock'
        db.delete_table(u'tradeschool_branchcontentblock')

        # Adding field 'Branch.header_copy'
        db.add_column(u'tradeschool_branch', 'header_copy',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'Branch.intro_copy'
        db.add_column(u'tradeschool_branch', 'intro_copy',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'Branch.footer_copy'
        db.add_column(u'tradeschool_branch', 'footer_copy',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'BranchContentBlock'
        db.create_table(u'tradeschool_branchcontentblock', (
        ...
        db.send_create_signal(u'tradeschool', ['BranchContentBlock'])

        # Deleting field 'Branch.header_copy'
        db.delete_column(u'tradeschool_branch', 'header_copy')

        # Deleting field 'Branch.intro_copy'
        db.delete_column(u'tradeschool_branch', 'intro_copy')

        # Deleting field 'Branch.footer_copy'
        db.delete_column(u'tradeschool_branch', 'footer_copy')
    ...
    models = {
        ...
        u'tradeschool.branch': {
            ...
            'footer_copy': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'header_copy': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intro_copy': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'tradeschool.person': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'26133597c81c11e2a61714109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'tradeschool.schedule': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 29, 0, 0)'}),
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'2614f2dcc81c11e2b02914109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '120', 'unique': 'True', 'null': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 29, 0, 0)'}),
        ...
        u'tradeschool.timerange': {
            ...
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tradeschool.Branch']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 29, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 29, 0, 0)'}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#bf0692'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
