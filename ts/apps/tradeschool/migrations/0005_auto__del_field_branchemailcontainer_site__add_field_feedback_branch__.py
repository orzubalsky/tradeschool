...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BranchEmailContainer.site'
        db.delete_column(u'tradeschool_branchemailcontainer', 'site_id')

        # Adding field 'Feedback.branch'
        db.add_column(u'tradeschool_feedback', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.Branch']),
                      keep_default=False)

        # Adding field 'BarterItem.branch'
        db.add_column(u'tradeschool_barteritem', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.Branch']),
                      keep_default=False)

        # Adding field 'RegisteredItem.branch'
        db.add_column(u'tradeschool_registereditem', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.Branch']),
                      keep_default=False)

        # Adding field 'Registration.branch'
        db.add_column(u'tradeschool_registration', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.Branch']),
                      keep_default=False)

        # Adding field 'Schedule.branch'
        db.add_column(u'tradeschool_schedule', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.Branch']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BranchEmailContainer.site'
        db.add_column(u'tradeschool_branchemailcontainer', 'site',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='emails', unique=True, to=orm['sites.Site']),
                      keep_default=False)

        # Deleting field 'Feedback.branch'
        db.delete_column(u'tradeschool_feedback', 'branch_id')

        # Deleting field 'BarterItem.branch'
        db.delete_column(u'tradeschool_barteritem', 'branch_id')

        # Deleting field 'RegisteredItem.branch'
        db.delete_column(u'tradeschool_registereditem', 'branch_id')

        # Deleting field 'Registration.branch'
        db.delete_column(u'tradeschool_registration', 'branch_id')

        # Deleting field 'Schedule.branch'
        db.delete_column(u'tradeschool_schedule', 'branch_id')
    ...
    models = {
        ...
        u'tradeschool.person': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'0d9f9d4ac59911e286cd14109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'tradeschool.schedule': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'0da18ef3c59911e2bae314109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#822352'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
