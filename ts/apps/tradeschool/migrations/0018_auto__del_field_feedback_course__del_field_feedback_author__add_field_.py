...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('tradeschool_feedback', 'course_id')

        # Deleting field 'Feedback.author'
        db.delete_column('tradeschool_feedback', 'author_id')

        # Adding field 'Feedback.schedule'
        db.add_column('tradeschool_feedback', 'schedule',
    ...
    def backwards(self, orm):
        ...
        db.add_column('tradeschool_feedback', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.Schedule']),
                      keep_default=False)

        # Adding field 'Feedback.author'
        db.add_column('tradeschool_feedback', 'author',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['tradeschool.Person'], unique=True),
                      keep_default=False)

        # Deleting field 'Feedback.schedule'
        db.delete_column('tradeschool_feedback', 'schedule_id')
    ...
    models = {
        ...
        'tradeschool.person': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'552649d7605c11e28f4114109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'tradeschool.photo': {
            ...
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'default': '2', 'to': "orm['tradeschool.Branch']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'tradeschool.schedule': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 16, 0, 0)'}),
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'5527d557605c11e2900414109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '120', 'unique': 'True', 'null': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 16, 0, 0)'}),
        ...
        'tradeschool.timerange': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'default': "'2'", 'to': "orm['sites.Site']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 16, 0, 0)'}),
        ...
        'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#3397c'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
