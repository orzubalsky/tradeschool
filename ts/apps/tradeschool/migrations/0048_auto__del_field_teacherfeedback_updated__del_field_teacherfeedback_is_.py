...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TeacherFeedback.updated'
        db.delete_column(u'tradeschool_teacherfeedback', 'updated')

        # Deleting field 'TeacherFeedback.is_active'
        db.delete_column(u'tradeschool_teacherfeedback', 'is_active')

        # Deleting field 'TeacherFeedback.created'
        db.delete_column(u'tradeschool_teacherfeedback', 'created')

        # Deleting field 'StudentReminder.updated'
        db.delete_column(u'tradeschool_studentreminder', 'updated')

        # Deleting field 'StudentReminder.is_active'
        db.delete_column(u'tradeschool_studentreminder', 'is_active')

        # Deleting field 'StudentReminder.created'
        db.delete_column(u'tradeschool_studentreminder', 'created')

        # Deleting field 'TeacherReminder.updated'
        db.delete_column(u'tradeschool_teacherreminder', 'updated')

        # Deleting field 'TeacherReminder.is_active'
        db.delete_column(u'tradeschool_teacherreminder', 'is_active')

        # Deleting field 'TeacherReminder.created'
        db.delete_column(u'tradeschool_teacherreminder', 'created')

        # Deleting field 'TeacherConfirmation.updated'
        db.delete_column(u'tradeschool_teacherconfirmation', 'updated')

        # Deleting field 'TeacherConfirmation.created'
        db.delete_column(u'tradeschool_teacherconfirmation', 'created')

        # Deleting field 'TeacherConfirmation.is_active'
        db.delete_column(u'tradeschool_teacherconfirmation', 'is_active')

        # Deleting field 'TeacherClassApproval.updated'
        db.delete_column(u'tradeschool_teacherclassapproval', 'updated')

        # Deleting field 'TeacherClassApproval.created'
        db.delete_column(u'tradeschool_teacherclassapproval', 'created')

        # Deleting field 'TeacherClassApproval.is_active'
        db.delete_column(u'tradeschool_teacherclassapproval', 'is_active')

        # Deleting field 'StudentFeedback.updated'
        db.delete_column(u'tradeschool_studentfeedback', 'updated')

        # Deleting field 'StudentFeedback.is_active'
        db.delete_column(u'tradeschool_studentfeedback', 'is_active')

        # Deleting field 'StudentFeedback.created'
        db.delete_column(u'tradeschool_studentfeedback', 'created')

        # Deleting field 'StudentConfirmation.updated'
        db.delete_column(u'tradeschool_studentconfirmation', 'updated')

        # Deleting field 'StudentConfirmation.created'
        db.delete_column(u'tradeschool_studentconfirmation', 'created')

        # Deleting field 'StudentConfirmation.is_active'
        db.delete_column(u'tradeschool_studentconfirmation', 'is_active')


    def backwards(self, orm):
        # Adding field 'TeacherFeedback.updated'
        db.add_column(u'tradeschool_teacherfeedback', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'TeacherFeedback.is_active'
        db.add_column(u'tradeschool_teacherfeedback', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'TeacherFeedback.created'
        db.add_column(u'tradeschool_teacherfeedback', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'StudentReminder.updated'
        db.add_column(u'tradeschool_studentreminder', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'StudentReminder.is_active'
        db.add_column(u'tradeschool_studentreminder', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'StudentReminder.created'
        db.add_column(u'tradeschool_studentreminder', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'TeacherReminder.updated'
        db.add_column(u'tradeschool_teacherreminder', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'TeacherReminder.is_active'
        db.add_column(u'tradeschool_teacherreminder', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'TeacherReminder.created'
        db.add_column(u'tradeschool_teacherreminder', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'TeacherConfirmation.updated'
        db.add_column(u'tradeschool_teacherconfirmation', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'TeacherConfirmation.created'
        db.add_column(u'tradeschool_teacherconfirmation', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'TeacherConfirmation.is_active'
        db.add_column(u'tradeschool_teacherconfirmation', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'TeacherClassApproval.updated'
        db.add_column(u'tradeschool_teacherclassapproval', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'TeacherClassApproval.created'
        db.add_column(u'tradeschool_teacherclassapproval', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'TeacherClassApproval.is_active'
        db.add_column(u'tradeschool_teacherclassapproval', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'StudentFeedback.updated'
        db.add_column(u'tradeschool_studentfeedback', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'StudentFeedback.is_active'
        db.add_column(u'tradeschool_studentfeedback', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'StudentFeedback.created'
        db.add_column(u'tradeschool_studentfeedback', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'StudentConfirmation.updated'
        db.add_column(u'tradeschool_studentconfirmation', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'StudentConfirmation.created'
        db.add_column(u'tradeschool_studentconfirmation', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'StudentConfirmation.is_active'
        db.add_column(u'tradeschool_studentconfirmation', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#3fd7ec'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
