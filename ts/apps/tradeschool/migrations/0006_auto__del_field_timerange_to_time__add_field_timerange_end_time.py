...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TimeRange.to_time'
        db.delete_column('tradeschool_timerange', 'to_time')

        # Adding field 'TimeRange.end_time'
        db.add_column('tradeschool_timerange', 'end_time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2012, 12, 25, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TimeRange.to_time'
        db.add_column('tradeschool_timerange', 'to_time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2012, 12, 25, 0, 0)),
                      keep_default=False)

        # Deleting field 'TimeRange.end_time'
        db.delete_column('tradeschool_timerange', 'end_time')
    ...
    models = {
        ...
        'tradeschool.person': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'3f83a9dc4ea411e2a6ed14109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'tradeschool.schedule': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'3f8515d74ea411e2a5ff14109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#e35e05'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
