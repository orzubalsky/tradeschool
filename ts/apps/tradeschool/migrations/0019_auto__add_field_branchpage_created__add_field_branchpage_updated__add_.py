...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BranchPage.created'
        db.add_column(u'tradeschool_branchpage', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 6, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'BranchPage.updated'
        db.add_column(u'tradeschool_branchpage', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 6, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'BranchPage.is_active'
        db.add_column(u'tradeschool_branchpage', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BranchPage.created'
        db.delete_column(u'tradeschool_branchpage', 'created')

        # Deleting field 'BranchPage.updated'
        db.delete_column(u'tradeschool_branchpage', 'updated')

        # Deleting field 'BranchPage.is_active'
        db.delete_column(u'tradeschool_branchpage', 'is_active')
    ...
    models = {
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#503c3d'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
