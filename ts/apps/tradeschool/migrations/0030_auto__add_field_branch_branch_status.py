...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Branch.branch_status'
        db.add_column(u'tradeschool_branch', 'branch_status',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Branch.branch_status'
        db.delete_column(u'tradeschool_branch', 'branch_status')
    ...
    models = {
        ...
        u'tradeschool.branch': {
            ...
            'branch_status': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '1'}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#716b0a'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
