...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimeRange.venue'
        db.add_column(u'tradeschool_timerange', 'venue',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tradeschool.Venue'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Venue.venue_type'
        db.delete_column(u'tradeschool_venue', 'venue_type')

        # Deleting field 'Venue.address_2'
        db.delete_column(u'tradeschool_venue', 'address_2')


    def backwards(self, orm):
        # Deleting field 'TimeRange.venue'
        db.delete_column(u'tradeschool_timerange', 'venue_id')

        # Adding field 'Venue.venue_type'
        db.add_column(u'tradeschool_venue', 'venue_type',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'Venue.address_2'
        db.add_column(u'tradeschool_venue', 'address_2',
    ...
    models = {
        ...
        u'tradeschool.schedule': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 31, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '255', 'unique': 'True', 'null': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 31, 0, 0)'}),
        ...
        u'tradeschool.timerange': {
            ...
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tradeschool.Branch']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 31, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 31, 0, 0)'}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#e70009'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
