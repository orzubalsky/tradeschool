...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tradeschool_person', 'username',
                      self.gf('django.db.models.fields.CharField')(default='a', unique=True, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.username'
        db.delete_column(u'tradeschool_person', 'username')
    ...
    models = {
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#243e50'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
