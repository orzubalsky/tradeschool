...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Branch.min_barteritems'
        db.add_column(u'tradeschool_branch', 'min_barteritems',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Branch.min_barteritems'
        db.delete_column(u'tradeschool_branch', 'min_barteritems')
    ...
    models = {
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#88c66c'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
