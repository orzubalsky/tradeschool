...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Photo.branch'
        db.delete_column('tradeschool_photo', 'branch_id')

        # Adding field 'Photo.site'
        db.add_column('tradeschool_photo', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Photo.branch'
        db.add_column('tradeschool_photo', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.Branch']),
                      keep_default=False)

        # Deleting field 'Photo.site'
        db.delete_column('tradeschool_photo', 'site_id')
    ...
    models = {
        ...
        'tradeschool.person': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'b2db86355ebd11e29e4b14109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'tradeschool.schedule': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 14, 0, 0)'}),
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'b2dd1d8c5ebd11e2a9c314109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '120', 'unique': 'True', 'null': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 14, 0, 0)'}),
        ...
        'tradeschool.timerange': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 14, 0, 0)'}),
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sites.Site']"}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 14, 0, 0)'}),
        ...
        'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#6df8a4'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
