...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tradeschool_teacherfeedback', 'Branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tradeschool.Branch'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'TeacherFeedback.Schedule'
        db.add_column(u'tradeschool_teacherfeedback', 'Schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tradeschool.Schedule'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'tradeschool.studentconfirmation': {
            ...
            'Schedule': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tradeschool.Schedule']", 'null': 'True', 'blank': 'True'}),
            'content': ('django.db.models.fields.TextField', [], {}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#de7e5a'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
