...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.venue'
        db.alter_column(u'tradeschool_course', 'venue_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tradeschool.Venue'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Course.venue'
        db.alter_column(u'tradeschool_course', 'venue_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tradeschool.Venue'], null=True))
    ...
    models = {
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#98ef71'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
