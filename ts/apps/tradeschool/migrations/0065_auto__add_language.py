...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field branches on 'Language'
        m2m_table_name = db.shorten_name(u'tradeschool_language_branches')
        ...
        db.create_unique(m2m_table_name, ['language_id', 'branch_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field branches on 'Language'
        db.delete_table(db.shorten_name(u'tradeschool_language_branches'))
    ...
    models = {
        ...
        u'tradeschool.language': {
            ...
            'branches': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'languages'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['tradeschool.Branch']"}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#a5c58b'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
