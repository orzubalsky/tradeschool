...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Branch.intro_copy'
        db.alter_column(u'tradeschool_branch', 'intro_copy', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'Branch.header_copy'
        db.alter_column(u'tradeschool_branch', 'header_copy', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'Branch.footer_copy'
        db.alter_column(u'tradeschool_branch', 'footer_copy', self.gf('tinymce.models.HTMLField')(null=True))

    def backwards(self, orm):

        # Changing field 'Branch.intro_copy'
        db.alter_column(u'tradeschool_branch', 'intro_copy', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Branch.header_copy'
        db.alter_column(u'tradeschool_branch', 'header_copy', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Branch.footer_copy'
        db.alter_column(u'tradeschool_branch', 'footer_copy', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'tradeschool.branch': {
            ...
            'footer_copy': ('tinymce.models.HTMLField', [], {'null': 'True'}),
            'header_copy': ('tinymce.models.HTMLField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intro_copy': ('tinymce.models.HTMLField', [], {'null': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'tradeschool.person': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'aa055d61cec611e29dca14109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '120'}),
        ...
        u'tradeschool.schedule': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 6, 0, 0)'}),
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'aa076c99cec611e2ab8214109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '120', 'unique': 'True', 'null': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 6, 0, 0)'}),
        ...
        u'tradeschool.timerange': {
            ...
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tradeschool.Branch']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 6, 0, 0)'}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#53b801'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
