...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cluster.slug'
        db.add_column(u'tradeschool_cluster', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='a', max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cluster.slug'
        db.delete_column(u'tradeschool_cluster', 'slug')
    ...
    models = {
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#9d7d7c'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
