...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BarterItem.requested'
        db.delete_column(u'tradeschool_barteritem', 'requested')
    ...
    def backwards(self, orm):
        # Adding field 'BarterItem.requested'
        db.add_column(u'tradeschool_barteritem', 'requested',
        ...
        db.add_column(u'tradeschool_barteritem', 'schedule',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tradeschool.Schedule'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'tradeschool.person': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'9d494bdcd1e511e29df914109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '120'}),
        ...
        u'tradeschool.schedule': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'9d4b38f3d1e511e2bd1514109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#e0fd1c'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
