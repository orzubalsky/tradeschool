...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tradeschool_course', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Course.slug'
        db.alter_column(u'tradeschool_course', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=120, null=True))
    ...
    models = {
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#98c424'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
