...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.default_branch'
        db.add_column(u'tradeschool_person', 'default_branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='default_branch', null=True, to=orm['tradeschool.Branch']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.default_branch'
        db.delete_column(u'tradeschool_person', 'default_branch_id')
    ...
    models = {
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#14e5d0'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
