...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'tradeschool_branchemailcontainer')

        # Deleting model 'ScheduleEmailContainer'
        db.delete_table(u'tradeschool_scheduleemailcontainer')

        # Adding field 'Branch.student_confirmation'
        db.add_column(u'tradeschool_branch', 'student_confirmation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.StudentConfirmation']),
                      keep_default=False)

        # Adding field 'Branch.student_reminder'
        db.add_column(u'tradeschool_branch', 'student_reminder',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.StudentReminder']),
                      keep_default=False)

        # Adding field 'Branch.student_feedback'
        db.add_column(u'tradeschool_branch', 'student_feedback',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.StudentFeedback']),
                      keep_default=False)

        # Adding field 'Branch.teacher_confirmation'
        db.add_column(u'tradeschool_branch', 'teacher_confirmation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.TeacherConfirmation']),
                      keep_default=False)

        # Adding field 'Branch.teacher_class_approval'
        db.add_column(u'tradeschool_branch', 'teacher_class_approval',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.TeacherClassApproval']),
                      keep_default=False)

        # Adding field 'Branch.teacher_reminder'
        db.add_column(u'tradeschool_branch', 'teacher_reminder',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.TeacherReminder']),
                      keep_default=False)

        # Adding field 'Branch.teacher_feedback'
        db.add_column(u'tradeschool_branch', 'teacher_feedback',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.TeacherFeedback']),
                      keep_default=False)

        # Adding unique constraint on 'Cluster', fields ['slug']
        db.create_unique(u'tradeschool_cluster', ['slug'])

        # Adding field 'Schedule.student_confirmation'
        db.add_column(u'tradeschool_schedule', 'student_confirmation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.StudentConfirmation']),
                      keep_default=False)

        # Adding field 'Schedule.student_reminder'
        db.add_column(u'tradeschool_schedule', 'student_reminder',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.StudentReminder']),
                      keep_default=False)

        # Adding field 'Schedule.student_feedback'
        db.add_column(u'tradeschool_schedule', 'student_feedback',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.StudentFeedback']),
                      keep_default=False)

        # Adding field 'Schedule.teacher_confirmation'
        db.add_column(u'tradeschool_schedule', 'teacher_confirmation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.TeacherConfirmation']),
                      keep_default=False)

        # Adding field 'Schedule.teacher_class_approval'
        db.add_column(u'tradeschool_schedule', 'teacher_class_approval',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.TeacherClassApproval']),
                      keep_default=False)

        # Adding field 'Schedule.teacher_reminder'
        db.add_column(u'tradeschool_schedule', 'teacher_reminder',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.TeacherReminder']),
                      keep_default=False)

        # Adding field 'Schedule.teacher_feedback'
        db.add_column(u'tradeschool_schedule', 'teacher_feedback',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.TeacherFeedback']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Cluster', fields ['slug']
        db.delete_unique(u'tradeschool_cluster', ['slug'])

        # Adding model 'BranchEmailContainer'
        db.create_table(u'tradeschool_branchemailcontainer', (
        ...
        db.send_create_signal(u'tradeschool', ['BranchEmailContainer'])

        # Adding model 'ScheduleEmailContainer'
        db.create_table(u'tradeschool_scheduleemailcontainer', (
            ('teacher_class_approval', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tradeschool.TeacherClassApproval'])),
            ('updated', self.gf('django.db.models.fields.DateTimeField')()),
            ('student_reminder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tradeschool.StudentReminder'])),
        ...
        db.send_create_signal(u'tradeschool', ['ScheduleEmailContainer'])
    ...
    models = {
        ...
        u'tradeschool.schedule': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)'}),
            'student_confirmation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tradeschool.StudentConfirmation']"}),
            'student_feedback': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tradeschool.StudentFeedback']"}),
            'student_reminder': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tradeschool.StudentReminder']"}),
        ...
        u'tradeschool.timerange': {
            ...
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tradeschool.Branch']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)'}),
        ...
        u'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#e8b867'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
