...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BranchNotification.branch'
        db.delete_column('notifications_branchnotification', 'branch_id')

        # Adding field 'BranchNotification.site'
        db.add_column('notifications_branchnotification', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BranchNotification.branch'
        db.add_column('notifications_branchnotification', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tradeschool.Branch']),
                      keep_default=False)

        # Deleting field 'BranchNotification.site'
        db.delete_column('notifications_branchnotification', 'site_id')
    ...
    models = {
        ...
        'notifications.schedulenotification': {
            'Meta': {'object_name': 'ScheduleNotification'},
            'content': ('django.db.models.fields.TextField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'tradeschool.person': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'d12c0919498e11e2a59314109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'tradeschool.schedule': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'d12d56ba498e11e2b59b14109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'tradeschool.venue': {
            ...
            'color': ('django.db.models.fields.CharField', [], {'default': "'#a4d41e'", 'max_length': '7'}),
