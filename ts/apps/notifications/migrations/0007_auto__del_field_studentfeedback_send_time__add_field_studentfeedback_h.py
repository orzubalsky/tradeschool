...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentFeedback.hours_delta'
        db.add_column('notifications_studentfeedback', 'hours_delta',
        ...
        # Adding field 'StudentReminder.hours_delta'
        db.add_column('notifications_studentreminder', 'hours_delta',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
        ...
        # Adding field 'TeacherFeedback.hours_delta'
        db.add_column('notifications_teacherfeedback', 'hours_delta',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
        ...
        # Adding field 'TeacherReminder.hours_delta'
        db.add_column('notifications_teacherreminder', 'hours_delta',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'StudentFeedback.hours_delta'
        db.delete_column('notifications_studentfeedback', 'hours_delta')
        ...
        # Deleting field 'StudentReminder.hours_delta'
        db.delete_column('notifications_studentreminder', 'hours_delta')
        ...
        # Deleting field 'TeacherFeedback.hours_delta'
        db.delete_column('notifications_teacherfeedback', 'hours_delta')
        ...
        # Deleting field 'TeacherReminder.hours_delta'
        db.delete_column('notifications_teacherreminder', 'hours_delta')
    ...
    models = {
        ...
        'notifications.studentfeedback': {
            ...
            'email_status': ('django.db.models.fields.CharField', [], {'default': "'not_sent'", 'max_length': '30'}),
            'hours_delta': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'tradeschool.person': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'7e6e3a80629411e2af5b14109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'tradeschool.schedule': {
            ...
            'hashcode': ('django.db.models.fields.CharField', [], {'default': "'7e6facba629411e2bca614109fdfc929'", 'unique': 'True', 'max_length': '32'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'tradeschool.venue': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'color': ('django.db.models.fields.CharField', [], {'default': "'#f702fc'", 'max_length': '7'}),
            'country': ('django_countries.fields.CountryField', [], {'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
