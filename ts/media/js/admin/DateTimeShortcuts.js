...
var DateTimeShortcuts = {
    ...
    addClock: function(inp) {
        ...
        for(var i=0; i<24; i++)
        {
            var text = (i < 12) ? i + ':00am' : i + ':00pm';
            quickElement("a", quickElement("li", time_list, ""), gettext(text), "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", new Date(1970,1,1,"+i+",0,0,0).strftime('" + time_format + "'));");
            text = (i < 12) ? i + ':30am' : i + ':30pm';            
            quickElement("a", quickElement("li", time_list, ""), gettext(text), "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ", new Date(1970,1,1,"+i+",30,0,0).strftime('" + time_format + "'));");                        
        }
